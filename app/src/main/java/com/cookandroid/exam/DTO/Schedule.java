...
public class Schedule {
    ...
    public Schedule(String color, String context, String endHms, String endYmd, String location, String startHms, String startYmd, String title, Double x, Double y){
        this.color = color;
        this.context = context;
        this.endHms = endHms;
        this.endYmd = endYmd;
